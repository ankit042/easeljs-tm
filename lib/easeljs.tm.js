(function() {
  ...
  createjs.tm.HSV = (function() {
    ...
    HSV.prototype.toRGB = function() {
      ...
      switch (i) {
        case 0:
          return new createjs.tm.RGB(v, z, x);
        case 1:
          return new createjs.tm.RGB(y, v, x);
        case 2:
          return new createjs.tm.RGB(x, v, z);
        case 3:
          return new createjs.tm.RGB(x, y, v);
        case 4:
          return new createjs.tm.RGB(z, x, v);
        case 5:
          return new createjs.tm.RGB(v, x, y);
      }
    };
    ...
    HSV.prototype.toCSSString = function(alpha) {
      return this.toRGB().toCSSString(alpha);
    };
  ...
  createjs.tm.RGB = (function() {
    ...
    RGB.prototype.toCSSString = function(alpha) {
      this.normalize();
      if (alpha != null) {
