(function() {
  ...
  createjs.tm.BitmapData = (function() {
    ...
    BitmapData.prototype._perlinNoise = function(width, height, numOctaves, randomSeed, stitch, persistence, channelOptions, grayScale, offsets) {
      var amplitude, baseX, baseY, factor, frequency, h, i, j, octave, octaves, offset, pixel, pixels, targetPixels, w, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _n;
      if (numOctaves == null) {
        numOctaves = 6;
      }
      if (randomSeed == null) {
  ...
  createjs.tm.KernelFilter = (function(_super) {
    ...
    KernelFilter.prototype.filter = function(width, height, pixels, targetPixels) {
      var b, g, i, kernel, kernelHeight, kernelWidth, kx, ky, pixelIndex, px, py, r, rx, ry, weight, x, y, _i, _j, _k, _ref;
      ...
      for (i = _i = 0, _ref = width * height; _i < _ref; i = _i += 1) {
        ...
        y = i / width >> 0;
        r = g = b = 0;
        for (kx = _j = 0; _j < kernelWidth; kx = _j += 1) {
          for (ky = _k = 0; _k < kernelHeight; ky = _k += 1) {
