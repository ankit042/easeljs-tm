  ...
  createjs.tm.Graphics = (function(_super) {
    ...
    Graphics.prototype.beginStroke = function(r, g, b, a) {
      if (arguments.length === 1) {
        return Graphics.__super__.beginStroke.apply(this, arguments).apply(this, arguments);
      }
    ...
    Graphics.prototype.beginFill = function(r, g, b, a) {
      if (arguments.length === 1) {
        return Graphics.__super__.beginFill.apply(this, arguments).apply(this, arguments);
      }
