(function() {
  var createjs, ___extend, _base, _ref,
    ...
    Graphics.prototype.beginStroke = function(r, g, b, a) {
      if (arguments.length === 1) {
        if (Object.prototype.toString.call(r) === '[object Number]') {
          return Graphics.__super__.beginStroke.call(this, new createjs.tm.RGB(r).toCSSString());
        }
        return Graphics.__super__.beginStroke.call(this, r);
      }
      return Graphics.__super__.beginStroke.call(this, Graphics.getRGB(r, g, b, a));
    };

    Graphics.prototype.beginFill = function(r, g, b, a) {
      if (arguments.length === 1) {
        if (Object.prototype.toString.call(r) === '[object Number]') {
          return Graphics.__super__.beginFill.call(this, new createjs.tm.RGB(r).toCSSString());
        }
        return Graphics.__super__.beginFill.call(this, r);
      }
      return Graphics.__super__.beginFill.call(this, Graphics.getRGB(r, g, b, a));
    };

    Graphics.prototype.beginRadialCircularGradientFill = function(hsv0, hsv1, numInterpolate, x0, y0, r0, x1, y1, r1) {
      var hsvs, i, ratios, _i;
      hsvs = [];
      ratios = [];
      for (i = _i = 0; _i <= numInterpolate; i = _i += 1) {
        hsvs[i] = createjs.tm.HSV.interpolate(hsv0, hsv1, Math.sin(PI_OVER_2 * i / numInterpolate)).toCSSString();
        ratios[i] = Math.sin(PI_OVER_2 * i / numInterpolate);
      }
      console.log(hsvs, ratios);
      return this.beginRadialGradientFill(hsvs, ratios, x0, y0, r0, x1, y1, r1);
    };
  ...
  createjs.tm.HSV = (function() {
    ...
    HSV.prototype.toRGB = function() {
      ...
      switch (i) {
        case 0:
          return new createjs.tm.RGB(v, z, x, a);
        case 1:
          return new createjs.tm.RGB(y, v, x, a);
        case 2:
          return new createjs.tm.RGB(x, v, z, a);
        case 3:
          return new createjs.tm.RGB(x, y, v, a);
        case 4:
          return new createjs.tm.RGB(z, x, v, a);
        case 5:
          return new createjs.tm.RGB(v, x, y, a);
      }
    };
