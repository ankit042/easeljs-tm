(function() {
  ...
  createjs.tm.BitmapData = (function() {
    ...
    BitmapData.prototype.noise = function(x, y, width, height, randomSeed, low, high, channelOptions, grayScale, offset) {
      if (low == null) {
        low = 0;
      }
      if (high == null) {
    ...
    BitmapData.prototype._noise = function(width, height, randomSeed, low, high, channelOptions, grayScale, _arg) {
    ...
    BitmapData.prototype.perlinNoise = function(x, y, width, height, baseX, baseY, numOctaves, randomSeed, stitch, fractalNoise, channelOptions, grayScale, offsets) {
      if (channelOptions == null) {
        channelOptions = 7;
      }
      if (grayScale == null) {
      ...
      this._updatePixels(x, y, width, height, this._perlinNoise(width, height, baseX, baseY, numOctaves, randomSeed, stitch, fractalNoise, channelOptions, grayScale, offsets));
      return this;
    };

    BitmapData.prototype._perlinNoise = function(width, height, baseX, baseY, numOctaves, randomSeed, stitch, fractalNoise, channelOptions, grayScale, offsets) {
      var h, i, j, k, octave, octaves, offset, persistence, persistences, pixel, pixels, scale, targetPixels, totalWeight, w, weight, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _n, _o;
      if (channelOptions == null) {
        channelOptions = 7;
      }
      if (grayScale == null) {
    ...
    BitmapData.prototype._scale = function(pixels, w, h, width, height, i) {
    ...
    BitmapData.prototype._updatePixels = function(x, y, width, height, pixels) {
