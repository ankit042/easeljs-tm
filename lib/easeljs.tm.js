(function() {
  ...
  createjs.tm.BitmapData = (function() {
    ...
    BitmapData.prototype.noise = function(baseX, baseY, randomSeed, stitch, low, high, channelOptions, grayScale, offset) {
      if (stitch == null) {
        stitch = false;
      }
      if (low == null) {
      ...
      this._updatePixels(this._noise(baseX, baseY, randomSeed, stitch, low, high, channelOptions, grayScale, offset));
      return this;
    };

    BitmapData.prototype._noise = function(baseX, baseY, randomSeed, stitch, low, high, channelOptions, grayScale, _arg) {
      var a, aChannel, b, bChannel, dx, dy, g, gChannel, height, i, j, k, levelMin, levelRange, pixels, r, rChannel, width, x, xor128, y, _i, _ref, _ref1;
      if (stitch == null) {
        stitch = false;
      }
      if (low == null) {
    ...
    BitmapData.prototype._perlinNoise = function(baseX, baseY, numOctaves, randomSeed, stitch, persistence, channelOptions, grayScale, offsets) {
      ...
      for (i = _k = 0, _len1 = octaves.length; _k < _len1; i = ++_k) {
        ...
        pixels = this._noise(baseX, baseY, randomSeed, stitch, 0, 0xff, channelOptions, grayScale, offset);
